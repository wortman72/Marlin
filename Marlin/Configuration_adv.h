...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN PB15           // Set a custom pin for the controller fan //was -1 MW
 ...
 */
#define E0_AUTO_FAN_PIN PC7 //was -1 MW
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu //broken -- fails to probe z initially
...
// The number of linear moves that can be in the planner at once.
  ...
  #define BLOCK_BUFFER_SIZE  32 //MW WAS 8
#elif HAS_MEDIA
  #define BLOCK_BUFFER_SIZE 64 //MW WAS 16
#else
  #define BLOCK_BUFFER_SIZE 64 //MW WAS 16
#endif
...
#define TX_BUFFER_SIZE 128 //MW WAS 0
